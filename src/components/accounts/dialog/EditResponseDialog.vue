<template>
    <div v-if="editResponseVisible">
      <el-dialog
        :visible.sync="editResponseVisible"
        width="30%"
        :before-close="handleClose"
      >
        <div slot="title" class="header-title">
          <span class="dialogTitle">Unable to activate network policy</span><br />
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button size="small" type="primary" @click="submit">Return to policies</el-button>
        </div>
      </el-dialog>
    </div>
</template>
